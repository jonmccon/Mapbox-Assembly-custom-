...
.select {
  ...
  border-radius: 4px;
  background-color: #448ee4; /* match btn default state */
}
...
.animation-fade-out { -webkit-animation: fadein 1.5s ease-out reverse forwards; animation: fadein 1.5s ease-out reverse forwards; }
...
.color-yellow-light {
  color: #f0f062 !important;
}

.color-yellow-faint {
  color: #fafbd1 !important;
}
...
.bg-yellow-faint {
  background-color: #fafbd1 !important;
}
